...
parser.add_argument("--train-set", default="/home/dataset/wlq/punctuateWithBERTFromDraft/BERTWithLinear/TN_ru_datatset/ru_train.txt", help="train dataset path")
parser.add_argument("--train-set-student", default="/home/dataset/wlq/punctuateWithBERTFromDraft/BERTWithLinear/TN_ru_datatset/ru_train.txt", help="train student dataset path")
parser.add_argument("--valid-set", default="/home/dataset/wlq/punctuateWithBERTFromDraft/BERTWithLinear/TN_ru_datatset/ru_jing_1000.txt", help="valid dataset path")
...
parser.add_argument("--epoch", default=40, help="train times")
...
parser.add_argument("--ckp", default="./checkpoint_TN_student_20230622_baseline", help="where to save the checkpoints")

parser.add_argument("--ckp-nums", default=20, help="how checkpoints to hold at the same time")
parser.add_argument("--tb", default="./tb_student_20230622_scheduler_baseline", help="where the tensorboard saved")
