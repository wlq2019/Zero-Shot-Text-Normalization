...
parser.add_argument("--train-set", default="en_train.txt", help="train dataset path")
parser.add_argument("--train-set-student", default="en_train.txt", help="train student dataset path")
parser.add_argument("--valid-set", default="en_test.txt", help="valid dataset path")
parser.add_argument("--test-set", default=None, help="en_test.txt")
