...
parser.add_argument("--train-set", default="/home/dataset/wlq/punctuateWithBERTFromDraft/BERTWithLinear/TN_en_datatset/train.txt", help="train dataset path")
parser.add_argument("--train-set-student", default="/home/dataset/wlq/punctuateWithBERTFromDraft/BERTWithLinear/TN_en_datatset/train.txt", help="train student dataset path")
parser.add_argument("--valid-set", default="/home/dataset/wlq/punctuateWithBERTFromDraft/BERTWithLinear/TN_en_datatset/3000_4.txt", help="valid dataset path")
parser.add_argument("--test-set", default=None, help="/home/dataset/wlq/punctuateWithBERTFromDraft/BERTWithLinear/TN_en_datatset/3000_4.txt")
parser.add_argument("--label-vocab", default="/home/dataset/wlq/punctuateWithBERTFromDraft/BERTWithLinear/label.dict.tsv", help="label vocabulary path")
...
parser.add_argument("--epoch", default=50, help="train times")
parser.add_argument("--device", default="cuda", help="whether use gpu or not")
parser.add_argument("--ckp_teacher", default="/home/dataset/wlq/punctuateWithBERTFromDraft/BERTWithLinear/checkpoint_TN_teacher/epoch19.pt", help="where to save the checkpoints")
parser.add_argument("--ckp", default="./checkpoint_TN_student_20230612_scheduler", help="where to save the checkpoints")

parser.add_argument("--ckp-nums", default=30, help="how checkpoints to hold at the same time")
parser.add_argument("--tb", default="./tb_student_20230612_scheduler", help="where the tensorboard saved")
...
if __name__ == '__main__':
    ...
    for epoch in range(1, args.epoch):
        ...
        for sentences, soft_labels,WFST_labels  in tqdm(train_dataloader, desc=f"[Epoch {epoch}]"):
            ...
            origin_loss_weight = min((batch * 0.000025)**2,1)

            wfst_loss_weight = max(1-(batch * 0.000025)**2,0.1)
