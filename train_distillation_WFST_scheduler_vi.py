...
parser.add_argument("--train-set", default="vi_train.txt", help="train dataset path")
parser.add_argument("--train-set-student", default="vi_train.txt", help="train student dataset path")
parser.add_argument("--valid-set", default="vi_test.txt", help="valid dataset path")
...
parser.add_argument("--epoch", default=21, help="train times")
...
parser.add_argument("--ckp", default="./checkpoint_TN_student_20230618_vi_baseline", help="where to save the checkpoints")

parser.add_argument("--ckp-nums", default=2, help="how checkpoints to hold at the same time")
parser.add_argument("--tb", default="./tb_student_20230618_vi_baseline", help="where the tensorboard saved")
