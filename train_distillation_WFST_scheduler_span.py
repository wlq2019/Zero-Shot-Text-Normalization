...
parser.add_argument("--train-set", default="sp_train.txt", help="train dataset path")
parser.add_argument("--train-set-student", default="sp_train.txt", help="train student dataset path")
parser.add_argument("--valid-set", default="sp_test.txt", help="valid dataset path")
parser.add_argument("--test-set", default=None, help="sp_test.txt")
...
parser.add_argument("--epoch", default=23, help="train times")
...
parser.add_argument("--ckp", default="./checkpoint_TN_student_20230618_span_baseline", help="where to save the checkpoints")

parser.add_argument("--ckp-nums", default=4, help="how checkpoints to hold at the same time")
parser.add_argument("--tb", default="./tb_student_20230618_span_baseline", help="where the tensorboard saved")
